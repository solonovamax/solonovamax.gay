...
class ComboTwemojiCrashSpecTest(example: SpecExample) : RendererSpecTest(example, optionsMap, OPTIONS) {
    companion object {
        private const val SPEC_RESOURCE = "/ext_emoji_crash_spec.md"
        ...
        init {
            ...
            // optionsMap["use-cheat"] = MutableDataSet().set(TwemojiExtension.EMOJI_HOST_PRECEDENCE, EmojiHostPreference.ANY_GITHUB_PREFERRED)
            // optionsMap["prefer-github"] = MutableDataSet().set(TwemojiExtension.EMOJI_HOST_PRECEDENCE, EmojiHostPreference.GITHUB)
